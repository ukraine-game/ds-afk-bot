...
`/role_shop` має кнопки `Купити`, `Продати` та `Створити`. Кнопка `Купити` відкриває список ролей без введення ID. Адміністратори керуються власником з ID `1455564327351226380`; роль адміністратора має ID `1542839885055004672`.
